...
/**
 * "0812345678" | "66812345678" | "+66812345678" → "+66812345678"; ไม่ถูกต้อง → null
 * รับเฉพาะเบอร์ไทย (+66) — แอปนี้ใช้ผู้ให้บริการ SMS ไทย และผู้ใช้เป็นคนไทยทั้งหมด
 * (หมายเหตุ: "+66..." ถูกจัดการโดยเคส 66-นำหน้า เพราะ replace ตัด + ออกแล้ว d = "66...")
 */
