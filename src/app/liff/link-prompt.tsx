...
import { CloseLiffButton } from "./link/close-button";

/**
 * การ์ด "ผูกบัญชีก่อนใช้งาน" — ให้ผู้เช่าผูกผ่านแชท (พิมพ์เบอร์ในแชท Chao-Dee)
 * เรนเดอร์ตรง ๆ (ไม่ redirect) เพราะ client-side redirect ใน LINE webview ไม่เสถียร → ค้าง/วน
 */
